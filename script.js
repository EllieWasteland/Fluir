document.addEventListener('DOMContentLoaded', () => {
    ...
    const dataService = {
        ...
        async saveData(appState) { return new Promise(resolve => { localStorage.setItem('foco-app-data-v1', JSON.stringify(appState)); resolve(); }); }
    };
